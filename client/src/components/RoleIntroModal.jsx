...
const ROLE_DETAILS = [
  {
    ...
    abilities: [
      '🐺 <strong>变狼</strong>：变身为狼人形态。变狼前不会被预言家查出。',
      '🦠 <strong>感染</strong>：感染一名玩家，下个夜晚变为狼人（预言家保留能力但查验反转）。',
      '🎭 <strong>假身份编织</strong>：变狼前可伪装成一种神职身份，被预言家查验时显示为该身份。使用感染后伪装失效。',
      '🔪 <strong>刀人</strong>：变狼后在狼人步骤与狼群一起选择击杀目标。',
      '💉 <strong>狼群激素</strong>（被动）：每有一只狼人被投票出局，获得一次额外感染机会。',
    ],
    tips: '💡 策略：先潜伏编织假身份，再择机变身。感染预言家是最强干扰——让好人的信息核心彻底混乱。',
  },
  {
    id: ROLES.WEREWOLF,
    name: '狼人',
    ...
    abilities: [
      '🔪 <strong>刀人</strong>：在狼人步骤击杀目标。锁定的是人而非屋子，会跟随目标移动。',
      '🐺 <strong>相认机制</strong>：去另一狼人家中则双方相认。互刀则相认不死。',
  ...
  },
  {
    ...
    teamName: '好人阵营',
    color: '#7d3c98',
    desc: '每夜查验一名玩家的身份。新增梦境线索、灵视和公开预言能力，是好人方最丰富的信息核心。',
    abilities: [
      ...
      '📢 <strong>公开预言</strong>（每局限1次，白天）：公开宣布查验结果。若判断错误则自己被投票出局——梭哈能力！',
      '🦠 <strong>被感染时</strong>：保留预言能力，但查验结果反转。获知种狼身份。',
    ],
    tips: '💡 策略：梦境碎片提供辅助推理线索。灵视可用来验证已死者的身份（确认之前查验是否正确）。公开预言是终极武器——用之前确保没被感染。',
  },
  {
    ...
    teamName: '好人阵营',
    color: '#2e7d32',
    desc: '烈性毒药可灭门，毒雾可设陷阱。新增毒药材料管理——用多少、什么时候用，都是决策。',
    abilities: [
      '☠️ <strong>烈性毒药</strong>：毒死目标屋子中所有人。消耗2份毒药材料。若屋内≥3人且有守卫：守卫重伤、其余毒死。',
      '🌫️ <strong>毒雾陷阱</strong>：在目标屋子释放延迟毒雾。下一晚进入该屋的人中毒。消耗1份材料。',
      '💊 <strong>药水</strong>：救活一名本应死亡的玩家。不能治疗守卫重伤。一次性使用。',
      '🧪 <strong>毒药材料</strong>（资源管理）：初始2份材料。2材料=1烈性毒药，1材料=1普通毒药。',
      '🛡️ <strong>抗毒体质</strong>（被动）：毒巫自己永远不会被毒死。',
      '👁️ <strong>知情权</strong>（被动）：守卫重伤时毒巫会获知。',
    ],
    tips: '💡 策略：毒雾是战略性武器——今晚设陷阱，明晚收网。材料管理是关键：用烈性毒药还是攒着做两个毒雾？',
  },
  {
    id: ROLES.HEAL_WITCH,
    name: '药巫',
    ...
    abilities: [
      '💚 <strong>万能药</strong>：治疗一切——死亡救活、重伤治愈。唯一能治疗守卫重伤的手段。一次性使用。',
  ...
  },
  {
    ...
    abilities: [
      ...
      '🏰 <strong>筑垒</strong>：加固目标屋子。狼人不能攻击该屋内的人（但毒巫的烈性毒药可击穿）。哈尔瓦德无法进入筑垒的屋子。',
    ...
    tips: '💡 策略：筑垒是战略性防御——保护关键角色被狼刀。巡逻换情报。舍身是终极大招——用自己换预言家/药巫活下来。',
  },
  {
    id: ROLES.HUNTER,
    name: '猎人',
    ...
    teamName: '好人阵营',
    color: '#d35400',
    desc: '第二晚起才能行动。猎枪追踪+短火铳反击+白天开枪+陷阱射击+复仇——五杀手段！',
    abilities: [
  ...
  },
  {
    ...
    abilities: [
      ...
      '👂 <strong>偷听</strong>：在目标屋子外偷听。基于屋内实际成员给线索（织布女的线索更精确）。',
      '🎯 <strong>8种子类型</strong>：',
      '　🔫 老猎人：20%概率识破进入自家的狼人；可在家设陷阱',
      '　📦 旅行商人：每晚可访问2个屋子；可交易信息',
      '　🌿 草药师：可推迟目标死亡1回合；感知谁被毒过',
      '　📖 说书人：讨论发言时间翻倍；可额外发言一次',
      '　👁️ 守夜人：察觉门外经过者；可获知今晚出门人数',
      '　🍞 面包师：知道更多人的夜晚去向；天亮时额外获知一条信息',
      '　🔨 铁匠：加固自家门锁（抵御一次狼人入侵）；被投出局带走一名投票者',
      '　🧵 织布女：偷听线索排除干扰项；感知谁进过自己家',
    ],
      ...
      <div className="modal-content role-intro-modal" onClick={e => e.stopPropagation()}>
        ...
        <div className="modal-body">
          <p className="intro-text">
            本局狼人杀共有 <strong>8种职业角色 + 8种村民子类型 + 10种表层身份</strong>，每个角色拥有多元的行动方式和能力。
